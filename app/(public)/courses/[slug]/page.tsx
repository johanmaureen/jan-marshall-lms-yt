                      ...
                      <CardContent className="p-6 hover:bg-muted/50 transition-colors">
                        <div className="flex items-center justify-between">
                          <div className="flex-items-center gap-4">
                            ...
                            <div>
                              <h3 className="text-xl font-semi-bold text-left">
                                {chapter.title}
                              </h3>
        ...
        <div className="sticky top-20">
          <Card className="py-0">
            <CardContent className="p-6">
              ...
              <div className="mb-6 space-y-3 roundd-lg bg-muted p-4">
                ...
                <div className="flex itesm-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium"> Toatl Lessons</p>
                    <p className="text-sm text-muted-foreground ">
                      {course.chapters.reduce(
                        (total, chapter) => total + chapter.lessons.length,
                        0,
              ...
              <div className="mb-6 space-y-3">
                ...
                <ul className="space-y2">
                  <li className="flex items-center gap-2 text-sm">
                    ...
                    <span>Full lidetime access</span>
                  </li>
                  <li className="flex items-center gap-2 text-sm">
                    <div className="rounded-full bg-green-500/10 text-green-500 p-1">
                      <CheckIcon className="size-3" />
